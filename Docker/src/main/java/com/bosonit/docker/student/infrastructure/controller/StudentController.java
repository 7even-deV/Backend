package com.bosonit.docker.student.infrastructure.controller;
...
import com.bosonit.docker.student.infrastructure.dto.output.StudentFullOutputDTO;
...
public class StudentController {
    ...
    public StudentOutputDTO getStudentId(@PathVariable(name = "id") String id,
            @RequestParam(name = "outputType", defaultValue = "simple") @NotNull String outputType) {
