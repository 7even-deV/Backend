package com.bosonit.backbusiness.trip.infrastructure.repository;
...
public interface TripRepository extends JpaRepository<Trip, UUID> {
    ...
    List<Trip> findByDepartureAndArrivalAndLocalDate(@Param("departure") String departure,
            @Param("arrival") String arrival, @Param("date") String date);
}
